...
VENDOR_BLOBS ?= vendor/vodafone/vfd700/vfd700-vendor.mk
$(call inherit-product-if-exists, $(VENDOR_BLOBS))

MTK_PROJECT_CONFIG ?= device/vodafone/vfd700/ProjectConfig.mk
...
TARGET_OTA_ASSERT_DEVICE := VFD700,vfd700,Vodafone,vodafone,VODAFONE
